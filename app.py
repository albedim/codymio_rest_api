...
from src.controller import UserController, RepoGithubController, ServerController, ContributedRepoController
...
app.register_blueprint(ContributedRepoController.contributedRepo)
